  ...
  return (
    <div className="grid gap-4 py-4">
      ...
      <div className="grid gap-2">
        ...
        <Input
          id="alt-text"
          placeholder="ex.: Brandon chicoteado seus escravos para escreverem mais rápido."
...
export function InsertImageUploadedDialogBody({
  ...
  return (
    <div className="grid gap-4 py-4">
      <div className="grid gap-2">
        <Label htmlFor="image-upload">Faça upload da imagem</Label>
        <Input
          id="image-upload"
          type="file"
      ...
      <div className="grid gap-2">
        ...
        <Input
          id="alt-text"
          placeholder="ex.: Brandon lançando a 99ª era de Mistborn."
          onChange={(e) => setAltText(e.target.value)}
          value={altText}
          data-test-id="image-modal-alt-text-input"
        />
