      ...
      <Conteudo>
        ...
        <Topico titulo="Reinos do Cosmere">
          <p>
            ...
            />
            . Segundo Sanderson, esses reinos foram estabelecidos desde o início
            do universo e são a base para a compreensão da realidade e da magia
            nos mundos do Cosmere.
          </p>

          <p>
            O Reino Físico é o que é percebido como o mundo material, onde os
            eventos tangíveis acontecem. o Reino Cognitivo reflete pensamentos,
            ideias e percepções, funcionando quase como um espelho do mundo
            físico, mas moldado pelas crenças e consciências. Já o Reino
            Espiritual contém as essências e ideais perfeitos de tudo, servindo
            como uma matriz que define o que cada coisa ou pessoa é em sua forma
            mais pura.
          </p>
          ...
          <p>
            Entretanto, há exceções. Pessoas com maior quantidade de Investidura
            em vida podem permanecer no Reino Cognitivo por mais tempo antes de
            serem atraídas para o Além. E ainda mais excepcionais são os
            Fractários — aqueles que carregaram parte do poder de um Fractal.
            Esses indivíduos têm uma ligação tão profunda com a Investidura que
            podem resistir indefinidamente ao chamado do Além, escolhendo se
            desejam ou não <em>atravessar</em>
          </p>

          <p>
            E enquanto a passagem para o Além não acontece, é possível reverter
            a morte em alguns casos. Por meio de magia, o corpo físico pode ser
            curado ou infundido com Investidura suficiente para restaurar a
            vida, ou então só para transformar o morto em uma Sombra Cognitiva
            duradoura. Contudo, certas mortes são irreversíveis.Aaqueles mortos
            pela{" "}
            <Enlaçar
          ...
          <p>
            Ademais, como a cura mágica no Cosmere funciona conectando as partes
            de alguém que estão <em>dispersas</em> nos reinos; ela acaba sendo
            limitada pela percepção de si que foi deixada no{" "}
            <Enlaçar
              destino="/reinos/reino-cognitivo"
              texto="Reino Cognitivo"
            />
            . Isto é, a forma como a pessoa se percebe influencia diretamente o
            processo de cura. Se alguém aceita uma característica como parte de
            si mesmo (como uma cicatriz ou deficiência), essa percepção é
            projetada no Reino Cognitivo, impedindo a restauração total segundo
            a forma perfeita e ideal que existe no{" "}
            <Enlaçar
              destino="/reinos/reino-espiritual"
              texto="Reino Espiritual"
            />
          ...
          <Subtopico titulo="Reino Físico">
            ...
            <p>
              ...
              conhecidas como e segue as leis comuns da física, a não ser quando
              a influência e/ou interferência de algum dos outros Reinos as
              modifica.
            </p>
            ...
            <p>
              ...
              aglomerado estelar composto por aproximadamente 50 a 100 estrelas.
              Dentro dele, estão dezesseis sistemas planetários conhecidos, que
              abrigam um total de dezenove planetas notáveis, além de diversos
              outros objetos celestes, como planetas anões, luas, constelações
              etc.
            </p>
            ...
            <p>
              ...
              estelar, mas o resultado dessas empreitadas permanece um mistério.
            </p>
          </Subtopico>
          ...
          <Subtopico titulo="Reino Cognitivo">
            ...
            <p>
              ...
              Físico, mas com diferenças marcantes. Ele é conhecido como o Reino
              do Pensamento, e é moldado diretamente pela percepção coletiva e
              as ideias predominantes dos habitantes de um mundo, influenciando
              sua aparência e estrutura ao espelhar o Reino Físico.
            </p>
            ...
            <p>
              ...
              Reino Cognitivo, porque as pessoas não passam muito tempo pensando
              no espaço entre os planetas.
            </p>
            ...
            <p>
              Outra peculiaridade do Reino Cognitivo é a inversão entre terra e
              água. No Reino Cognitivo, as terras firmes do Físico se tornam
          ...
          <Subtopico titulo="Reino Espiritual">
              ...
              <li id="intenção" className={id_props}>
                ...
                <div className="flex flex-col gap-3 mt-3">
                  <p>
                    ...
                    representa a vontade ou propósito essencial de uma pessoa ou
                    entidade. Ela não é algo esporádico, acidental ou fortuito;
                    se a Intenção é necessária para realizar algo, a pessoa que
                    tenta fazê-lo deve não apenas executar a ação, mas também
                    ter a intenção deliberada de realizá-la. Muitas magias dos
                    mundos de Brandon Sanderson dependem dessa característica,
                    exigindo que o usuário aja conscientemente com Intenção para
                    ativar ou manipular a Investidura.
                  </p>
              ...
              <li id="identidade" className={id_props}>
                ...
                <div className="flex flex-col gap-3 mt-3">
                  <p>
                    ...
                    atributos armazenados por ele mesmo, já que a Identidade de
                    quem armazenou deve corresponder à Identidade de quem tenta
                    recuperar.
                  </p>
                  ...
                  <p>
                    ...
                    />
                    , que pode ser vista como um <em>DNA espiritual</em>. Embora
                    as Teias Espirituais ainda não tenham sido completamente
                    explicadas, sabe-se que elas:
                  </p>
              ...
              <li id="conexão" className={id_props}>
                ...
                <div className="flex flex-col gap-3 mt-3">
                  <p>
                    ...
                    armazena os vínculos espirituais entre diferentes entidades
                    no Cosmere, como seres vivos, locais, itens e até conceitos
                    abstratos. Esses vínculos transcendem o Reino Físico e têm
                    implicações práticas e mágicas.
                  </p>
                  ...
                  <p>
                    ...
                    nativo. Essa aplicação é um dos exemplos mais conhecidos da
                    manipulação de Conexões no Cosmere.
                  </p>
              ...
              <li id="sorte" className={id_props}>
                ...
                <div className="flex flex-col gap-3 mt-3">
                  <p>
                    ...
                    criados por Sanderson, especialmente através da manipulação
                    da Investidura.
                  </p>
                  ...
                  <p>
                    ...
                    complicado. Esse tipo de previsão frequentemente resulta em
                    visões imprecisas ou subjetivas, limitadas pela complexidade
                    do futuro e pelas inúmeras variáveis envolvidas.
                  </p>
                </div>
              </li>
            </ul>
            ...
            <p>
              ...
              imperfeições físicas ou distorções cognitivas. É essa versão ideal
              que muitas vezes serve como base para magias de cura e restauração
              nos mundos do Cosmere.
            </p>
          </Subtopico>
        </Topico>
        ...
        <Topico titulo="Investidura">
          ...
          <p>
            ...
            Cosmere, juntamente com a matéria e a energia. Ela pode ser descrita
            como uma energia espiritual que permeia e transcende os Reinos
            Físico, Cognitivo e Espiritual.
          </p>
          ...
          <Subtopico titulo="Origem e ruptura">
            ...
            <p>
              Sanderson descreve a Ruptura como algo que “significou tudo e nada
              ao mesmo tempo” para a Investidura. Isso sugere que, embora a
              Investidura tenha sido fragmentada, sua essência ainda reflete a
              unidade original de Adonalsium.
            </p>
          </Subtopico>
          ...
          <Subtopico titulo="Interação e corrupção">
            <p>
              ...
              frequentemente geram um efeito vermelho em manifestações mágicas.
            </p>
        ...
        <Topico titulo="Bibliografia">
          <CriarReferencia qual={3}>
            ...
            estamos falando nos fragmentos de Adonalsium e daqueles que portaram
            os Fractais de Adonalsium. Não confundir com os Fractais e os
            Fractários de Roshar que aparecem em Os relatos da Guerra da
            Tempestades.
          </CriarReferencia>
        </Topico>
      </Conteudo>
