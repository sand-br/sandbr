...
export const placeholder = 'Digite / para formatar rapidamente'
const maxLength = 500
          ...
          contentEditable={
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable placeholder={placeholder} className='ContentEditable__root relative block overflow-auto min-h-full px-8 py-4 focus:outline-none h-[830px]' />
              </div>
            </div>
          }
